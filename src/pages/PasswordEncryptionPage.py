# pages/PasswordEncryptionPage.py
...
class PasswordEncryptionPage(BasePage):
    ...
    def init(self):
        ...
        self.find_element_if_present(WEB_SETTINGS_menu_locator).click()
    ...
    def get_password_encryption_tier2_header_text(self):
        get_password_encryption_tier2_header_locator = (By.CSS_SELECTOR, "div:nth-child(2) > fieldset > legend")

        return self.find_element_then_get_text(get_password_encryption_tier2_header_locator)

    def get_password_encryption_title_text(self):
