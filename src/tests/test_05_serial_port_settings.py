...
class TestSerialPortSettings:
    ...
    def test_check_baud_rate_default_value(self, serial_port_settings_page):
        ...
        assert expected_title == title, "baud rate is not correct"
        assert expected_value == value, "baud rate value is not correct"
    ...
    def test_check_auto_logout_default_value(self, serial_port_settings_page):
        ...
        assert expected_title == title, "auto logout is not correct"
        assert expected_value == value, "auto logout value is not correct"
    ...
    def test_check_data_bits_default_value(self, serial_port_settings_page):
        ...
        assert expected_title == title, "data bits is not correct"
        assert expected_value == value, "data bits value is not correct"
    ...
    def test_check_parity_bits_default_value(self, serial_port_settings_page):
        ...
        assert expected_title == title, "parity bits is not correct"
        assert expected_value == value, "parity bits value is not correct"
